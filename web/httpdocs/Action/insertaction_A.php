...
<div id="wrapper">
    ...
    <div class="container-fluid">
        <h2>Action</h2>
        <form enctype="multipart/form-data" action="addactionA.php" method="POST">
           <fieldset>  
                ...
                <input type="radio" name="option_id" value="4" id="option_id" checked="checked" >
                Accessory    
                
                <label><b>ประเภทสินค้า</b></label>
                <input type="radio" name="type_id" value="4" id="type_id" checked="checked"> Action 
                 ...
                 <table>
                    ...
                    <tr> <td>เงินประกันแบบที่2 :</td>
                     ...
                     <input type="hidden" name="MAX_FILE_SIZE" value="1000000" />
                      ...
                      <input type="submit" name="upload" value="Send File" class="btn btn-primary" />
    </fieldset>
</form>
