<head>
        <meta charset="UTF-8">
        <title>เพิ่มข้อมูลของ Accessary</title>
        <style>
            label{
                display: block;
            }
    ...
    <body>
        <h2>Accessary</h2>
        <form enctype="multipart/form-data" action="addaccessary.php" method="POST">
           <fieldset>  
                ...
                <input type="radio" name="type_id" value="1" id="type_id" checked="checked" > Accessary
                <label>สถานะ</label>
            ...
            <label>Model:</label>
            <input name="acc_model" type="text" id="acc_model">
            <label>Spec:</label>
            <textarea  name="acc_description"  id="acc_description" cols="50" rows="7" wrap="soft"></textarea>
                <table>
                    <b>ราคา</b>
                    <tr>
                         <td>ราคาเครื่อง</td>
                         <td><input name="acc_price" type="text" id="acc_price" size="21"  > บาท</td>
                    </tr>
                    <tr> 
                        <td>ราคาต่อวัน</td> 
                         <td><input name="acc_priceperday" type="text" id="acc_priceperday" size="21"  > บาท/วัน</td>
                    </tr>
                </table>
                <table>
                    <b>วงเงินประกัน</b>
