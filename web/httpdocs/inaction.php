 <head>
        <meta charset="UTF-8">
        <title>เพิ่มข้อมูลของ Action</title>
        <style>
            label{
                display: block;
            }
    ...
    <body>
        <h2>Action</h2>
        <form enctype="multipart/form-data" action="addaction.php" method="POST">
           <fieldset>  
                ...
                <input type="radio" name="type_id" value="1" id="type_id" checked="checked" > Action 
                <label>สถานะ</label>
            ...
            <input name="action_name" type="text" id="action_name"  >             
            <label>Model:</label>
            <input name="action_model" type="text" id="action_model">
            <label>Spec:</label>
            <textarea  name="action_description"  id="action_description" cols="50" rows="7" wrap="soft"></textarea>
                <table>
                    <b>ราคา</b>
                    <tr>
                         <td>ราคาเครื่อง</td>
                         <td><input name="action_price" type="text" id="action_price" size="21"  > บาท</td>
                    </tr>
                    <tr> 
                        <td>ราคาต่อวัน</td> 
                         <td><input name="action_priceperday" type="text" id="action_priceperday" size="21"  > บาท/วัน</td>
                    </tr>
                </table>
                <table>
                    <b>วงเงินประกัน</b>
