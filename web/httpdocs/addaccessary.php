<?php
 function imageResize( $ext, $ori_file, $new_file )
   ...
   if(move_uploaded_file($fileTmpLoc,"accessary/$fileName")){
       ...
       $acc_model=$_POST['acc_model'];
       $acc_description=$_POST['acc_description'];
       $acc_price=$_POST['acc_price'];
       $acc_priceperday=$_POST['acc_priceperday'];
       ...
       $con = mysqli_connect('localhost', 'manocame', 'Pern1234') or die('nooo'. mysqli_connect_error());
        ...
        $sql = "INSERT INTO accessary (acc_name,brand_id,option_id,type_id,status_id,acc_image,acc_model,acc_description,acc_price,acc_priceperday,deposit_1,deposit_2) 
		VALUES('$acc_name','$brand_id','$option_id','$type_id','$status_id','$fileName','$acc_model','$acc_description','$acc_price','$acc_priceperday','$deposit_1','$deposit_2')";
