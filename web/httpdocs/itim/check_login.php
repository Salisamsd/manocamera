<?php
	...
	$objQuery = mysqli_query($objCon,$strSQL); //--บรรทัดนี้ต้องมี
	$objResult = mysqli_fetch_array($objQuery,MYSQLI_ASSOC); //ให้เฟดออกมาเป็นarray
	if(!$objResult)
	{
			echo "<script>";//--scriptเอาไว้เป็นการแจ้งเตือนขึ้นมา
