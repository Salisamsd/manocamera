<?php
 function imageResize( $ext, $ori_file, $new_file )
   ...
   if(move_uploaded_file($fileTmpLoc,"video/$fileName")){
       ...
       $vdo_model=$_POST['vdo_model'];
       $vdo_description=$_POST['vdo_description'];
       $vdo_price=$_POST['vdo_price'];
       $vdo_priceperday=$_POST['vdo_priceperday'];
       ...
       $con = mysqli_connect('localhost', 'manocame', 'Pern1234') or die('nooo'. mysqli_connect_error());
        ...
        $sql = "INSERT INTO video (vdo_name,brand_id,option_id,type_id,status_id,vdo_image,vdo_model,vdo_description,vdo_price,vdo_priceperday,deposit_1,deposit_2) 
		VALUES('$vdo_name','$brand_id','$option_id','$type_id','$status_id','$fileName','$vdo_model','$vdo_description','$vdo_price','$vdo_priceperday','$deposit_1','$deposit_2')";
