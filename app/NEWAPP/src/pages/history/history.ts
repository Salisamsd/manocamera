...
export class HistoryPage  {
  ...
  items:any=[];items1:any=[];items2:any=[];
  data:any;
  telephone:any;
  username:any;
  nationID:any;
  rentID:any;
  constructor(platform: Platform,public navCtrl: NavController, public navParams: NavParams,  private http: Http,  public loading: LoadingController,public modalCtrl: ModalController) {
    ...
    .map(res => res.json())
        ...
        this.http.post('http://manocamera.com/api/RentHistory.php',data, options)
        ...
        .map(res => res.json())
            ...
            this.http.post('http://manocamera.com/api/RentCancel.php',data, options)
