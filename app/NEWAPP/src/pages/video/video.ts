...
export class VideoPage {
  ...
  constructor(
    ...
    // this.http
    //   .get("http://manocamera.com/api/video/list_video_BL.php")
    //   .map(res => res.json())
    //   .subscribe(data => {
    ...
    // this.http
    //   .get("http://manocamera.com/api/video/list_video_L.php")
    //   .map(res => res.json())
    //   .subscribe(data => {
    ...
    // this.http
    //   .get("http://manocamera.com/video/dslr/list_video_A.php")
    //   .map(res => res.json())
    //   .subscribe(data => {
