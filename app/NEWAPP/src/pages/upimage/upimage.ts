...
export class UpimagePage {
  ...
  var headers = new Headers();
    ...
    this.http.post('http://manocamera.com/api/fetchphoto.php',data, options)
  ...
  uploadImage(){
    ...
    fileTransfer.upload(this.myphoto,'http://www.manocamera.com/uploadFoto.php', options)
      .then((data) => {
        alert("Success");
        loader.dismiss();
      }, (err) => {
  ...
  uploadImage2(){
    ...
    //file transfer action
    fileTransfer.upload(this.myphoto,'http://www.manocamera.com/uploadFoto2.php', options)
      .then((data) => {
        alert("Success");
        loader.dismiss();
      }, (err) => {
      ...
      uploadImage3(){
        ...
        //file transfer action
        fileTransfer.upload(this.myphoto,'http://www.manocamera.com/uploadFoto3.php', options)
          .then((data) => {
            alert("Success");
            loader.dismiss();
          }, (err) => {
