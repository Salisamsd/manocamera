        ...
        <div class="w3-row">
            ...
            <tr>
                ...
                <th>ข้อมุลเช่า</th>
                 ...
                 <tr><td>วันที่รับ</td><td ><?php echo$rowitem['edate'] ;?></td></tr>
                 ...
                 <tr><td>ผู้เช่า </td><td> <?php echo $rowitem['username'] ;?> 
                         <br> <h3 > <font COLOR="Red">กรุณาตรวจสอบเอกสารผู้เช่า </font></h3>
                 <a class="btn btn-warning" href="checkimg.php?username=<?php echo ($rowitem['username']) ;?>" role="button">รายละเอียด</a>
                 </td> 
                </tr> 
        </table>
           

            <center><a class="btn btn-primary"  href="conf1.php?id=<?php echo ($rowitem['id']) ;?>" role="button">ยันยืนการเช่า</a>
