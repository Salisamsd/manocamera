...
<div id="wrapper">
    ...
    <div class="container-fluid" >
        ...
        <div class="w3-row">
            ...
            <center><a class="btn btn-primary"  href="conf2.php?id=<?php echo ($rowitem['id']); ?>" role="button">การเช่าสำเร็จ</a>
                <a class="btn btn-danger"  href="checkimg.php?username=<?php echo ($rowitem['username']); ?>" role="button">ยกเลิกการเช่า</a></center>
